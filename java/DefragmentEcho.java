...
public class DefragmentEcho {
  ...
  private static final String PCAP_FILE_KEY = DefragmentEcho.class.getName()
      + ".pcapFile";
  private static final String PCAP_FILE = System.getProperty(PCAP_FILE_KEY,
      "src/main/resources/flagmentedEcho.pcap");
  ...
  public static void main(String[] args)
    ...
    while (true) {
      try {
        ...
        Short id = packet.get(IpV4Packet.class).getHeader()
            .getIdentification();
